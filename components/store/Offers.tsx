...
const OFFERS = [
  {
    ...
    accent: "#2dd4bf",
    featured: false,
    blurb: "The whole catalog, open and anonymous.",
  ...
  },
  {
    ...
    accent: "#34d399",
    featured: true,
    blurb: "Certify a model or agent against the verified corpus.",
  ...
  },
  {
    ...
    accent: "#8b7bff",
    featured: false,
    blurb: "The full fixtures + the live delta, licensed for training.",
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 18 }}>
        {OFFERS.map((o) => (
          ...
          >
            ...
            <div className="mono" style={{ fontSize: 26, fontWeight: 600, letterSpacing: "-0.02em", marginBottom: 6 }}>{o.price}</div>
